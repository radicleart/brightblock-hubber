...
<div class="col-sm-10">
  ...
  <div class="row">
    ...
    <div class="col-sm-10"><a href="#" class="badge badge-primary white" @click.prevent="toggleDebugMode">{{debugMode}}</a></div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-10">
      <a href="#" class="badge badge-primary white" @click.prevent="gaiaHubInfoCheck">Check Hub Info</a>
      <a href="#" class="badge badge-primary white" @click.prevent="gaiaListFilesCheck">Check List Files</a>
      <a href="#" class="badge badge-primary white" @click.prevent="gaiaStoreCheck">Store Random File</a>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    gaiaStoreCheck (file) {
      ...
      axios({
        method: 'post',
        url: this.gaiaHubUrl + '/store/' + this.address + '/gaia_store_test.json',
        data: data,
        headers: {
          'Content-Type': 'application/json',
          'Authorization': 'Bearer ' + gaiaAuthToken
